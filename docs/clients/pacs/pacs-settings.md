# Como Integrar com o Servidor PACS UniRadio
...
![Menu do usuário](/images/clients/pacs/pacs-settings/01-menu.jpeg)

### 3. Clique em "Servidor PACS"

![Servidor PACS](/images/clients/pacs/pacs-settings/02-server-pacs.jpeg)
