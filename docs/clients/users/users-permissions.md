# Como Editar as Permissões de um Usuário na Conta
...
![Menu do usuário](/images/clients/users/users-permissions/01-menu.jpeg)

### 3. Clique em "Usuários"

![Usuários](/images/clients/users/users-permissions/02-users.jpeg)

### 4. Selecione o usuário que deseja editar

Clique sobre o usuário na lista.

![Selecionar usuário](/images/clients/users/users-permissions/03-select-user.jpeg)

### 5. Clique em "Permissões"

![Permissões](/images/clients/users/users-permissions/04-permissions.jpeg)
...
![Selecionar função](/images/clients/users/users-permissions/05-role.jpeg)
...
![Selecionar permissões do membro](/images/clients/users/users-permissions/06-permissions-membro.jpeg)

### 8. Clique em "Salvar"

![Salvar alterações](/images/clients/users/users-permissions/07-save.jpeg)
