...
![Menu do usuário](/images/clients/security/2fa-disable/01-menu-user.jpeg)

### 3. Clique em "Meu Perfil"

![Usuários](/images/clients/security/2fa-disable/02-my-profile.jpeg)

### 4. Clique em "Desativar"

Localize a opção de autenticação de dois fatores e clique em **"Desativar"**.

![Desativar autenticação de dois fatores](/images/clients/security/2fa-disable/03-deactivate.jpeg)

### 5. Clique em "Continuar" para confirmar a desativação

![Confirmar desativação](/images/clients/security/2fa-disable/04-confirm.jpeg)
