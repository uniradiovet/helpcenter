...
![Menu do usuário](/images/clients/security/2fa/01-menu-user.jpeg)

### 3. Clique em "Meu Perfil"

![Usuários](/images/clients/security/2fa/02-my-profile.jpeg)
...
![Autenticação de dois fatores desativada](/images/clients/security/2fa/03-2fa-desativada.jpeg)

### 5. Clique em "Ativar"

Selecione o método desejado e clique em **"Ativar"** para iniciar a ativação.

![Ativar autenticação de dois fatores](/images/clients/security/2fa/04-activate.jpeg)
...
![Validar autenticação](/images/clients/security/2fa/05-validar.jpeg)

### 7. Clique em "Confirmar"

Clique no botão de **"Confirmar"** para concluir a ativação.

![Inserir código de verificação](/images/clients/security/2fa/06-confirm.jpeg)
