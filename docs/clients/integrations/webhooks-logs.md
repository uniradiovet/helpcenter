...
![Configurações da conta](/images/clients/integrations/webhooks-logs/01-menu.jpeg)

### 3. Clique em "Integrações"

![Integrações](/images/clients/integrations/webhooks-logs/02-integrations.jpeg)

### 4. Clique em "Webhooks"

![Webhooks](/images/clients/integrations/webhooks-logs/03-webhooks.jpeg)

### 5. Clique em "Logs"

Acesse a aba de logs do webhook desejado.

![Logs](/images/clients/integrations/webhooks-logs/04-logs.jpeg)
...
![Lista de logs](/images/clients/integrations/webhooks-logs/05-lista-logs.jpeg)

### 7. Clique em "Ver detalhes" para inspecionar um evento

![Ver detalhes](/images/clients/integrations/webhooks-logs/06-ver-details.jpeg)
...
![Detalhes do evento](/images/clients/integrations/webhooks-logs/07-details-event.jpeg)
