# Como Configurar as Definições do Laudo
...
![Menu de configurações](/images/radiologists/report/report-settings/01-menu.jpeg)

### 3. Clique em "Laudos"

No menu de configurações, clique em **"Laudos"** para acessar as definições do laudo.

![Laudos](/images/radiologists/report/report-settings/02-reports.jpeg)
...
![Editar informações](/images/radiologists/report/report-settings/03-edit.jpeg)

### 5. Clique em "Salvar"

Após realizar as alterações desejadas, clique em **"Salvar"** para confirmar as configurações.

![Salvar](/images/radiologists/report/report-settings/04-save.jpeg)

## Precisa de Ajuda?

Confira nossas [Perguntas Frequentes](/perguntas-frequentes) ou entre em contato com o suporte se encontrar problemas ao configurar as definições do laudo.
