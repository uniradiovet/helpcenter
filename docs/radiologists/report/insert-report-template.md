# Como Inserir um Modelo de Laudo em um Exame
...
![Aba Em Andamento](/images/radiologists/report/inserir-modelo-laudo/01-in-progress.jpeg)

### 3. Selecione o exame

Clique sobre o exame no qual deseja inserir o modelo de laudo.

![Selecionar exame](/images/radiologists/report/inserir-modelo-laudo/02-select-exam.jpeg)
...
![Usar um modelo](/images/radiologists/report/inserir-modelo-laudo/03-use-template.jpeg)

### 5. Selecione o modelo desejado (se clicar em "Usar um modelo")

Escolha o modelo de laudo que deseja aplicar ao exame.

![Selecionar modelo](/images/radiologists/report/inserir-modelo-laudo/04-select-template.jpeg)

### 6. Clique em "Inserir"

Clique em **"Inserir"** para aplicar o modelo ao laudo. O conteúdo será preenchido automaticamente no editor.

![Inserir modelo](/images/radiologists/report/inserir-modelo-laudo/05-inserir.jpeg)
