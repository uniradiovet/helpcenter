...
![Menu lateral](/images/radiologists/report/create-report-templates/01-menu.jpeg)

### 3. Acesse "Modelos de Laudos"

No menu lateral, clique em **"Modelos de Laudos"** para acessar a listagem de modelos existentes.

![Modelos de Laudos](/images/radiologists/report/create-report-templates/02-templates-reports.jpeg)

### 4. Clique em "Novo modelo de laudo"

Clique no botão **"Novo modelo de laudo"** para iniciar a criação de um novo modelo.

![Novo modelo de laudo](/images/radiologists/report/create-report-templates/03-new-template.jpeg)
...
![Preencher formulário](/images/radiologists/report/create-report-templates/04-fill-formulario.jpeg)

### 6. Clique em "Salvar"

Após preencher todas as informações, clique em **"Salvar"** para registrar o novo modelo de laudo.

![Salvar](/images/radiologists/report/create-report-templates/05-save.jpeg)
