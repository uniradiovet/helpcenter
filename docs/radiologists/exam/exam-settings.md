# Como Editar as Configurações de Exames
...
![Menu de configurações](/images/radiologists/exam/exam-settings/01-menu.jpeg)

### 3. Clique em "Exames"

No menu de configurações, clique em **"Exames"** para acessar as configurações de exames.

![Exames](/images/radiologists/exam/exam-settings/02-exams.jpeg)
...
![Configurações de exames](/images/radiologists/exam/exam-settings/03-settings.jpeg)

### 5. Clique em "Salvar"

Após realizar as alterações desejadas, clique em **"Salvar"** para confirmar as configurações.

![Salvar](/images/radiologists/exam/exam-settings/04-save.jpeg)

## Precisa de Ajuda?

Confira nossas [Perguntas Frequentes](/faq) ou entre em contato com o suporte se encontrar problemas ao configurar os exames.
