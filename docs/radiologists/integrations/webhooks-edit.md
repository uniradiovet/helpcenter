...
![Menu de configurações](/images/radiologists/integrations/webhooks-edit/01-menu.jpeg)

### 3. Clique em "Integrações"

No menu de configurações, clique em **"Integrações"** para acessar as opções de integração.

![Integrações](/images/radiologists/integrations/webhooks-edit/02-integrations.jpeg)

### 4. Clique em "Webhooks"

Dentro das integrações, clique em **"Webhooks"** para visualizar os webhooks cadastrados.

![Webhooks](/images/radiologists/integrations/webhooks-edit/03-webhooks.jpeg)

### 5. Clique em "Editar"

Localize o webhook que deseja modificar e clique em **"Editar"**.

![Editar webhook](/images/radiologists/integrations/webhooks-edit/04-edit.jpeg)
...
![Formulário de edição](/images/radiologists/integrations/webhooks-edit/05-formulario.jpeg)

### 7. Clique em "Salvar"

Após realizar as alterações desejadas, clique em **"Salvar"** para confirmar.

![Salvar alterações](/images/radiologists/integrations/webhooks-edit/06-save.jpeg)
