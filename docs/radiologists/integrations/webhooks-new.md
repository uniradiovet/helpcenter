...
![Menu de configurações](/images/radiologists/integrations/webhooks-new/01-menu.jpeg)

### 3. Clique em "Integrações"

No menu de configurações, clique em **"Integrações"** para acessar as opções de integração.

![Integrações](/images/radiologists/integrations/webhooks-new/02-integrations.jpeg)

### 4. Clique em "Webhooks"

Dentro das integrações, clique em **"Webhooks"** para gerenciar os webhooks da conta.

![Webhooks](/images/radiologists/integrations/webhooks-new/03-webhooks.jpeg)

### 5. Clique em "Novo Webhook"

Clique no botão **"Novo Webhook"** para iniciar o cadastro.

![Novo Webhook](/images/radiologists/integrations/webhooks-new/04-new-webhook.jpeg)
...
![Formulário de webhook](/images/radiologists/integrations/webhooks-new/05-formulario.jpeg)

### 7. Clique em "Salvar"

Após preencher as informações, clique em **"Salvar"** para confirmar o cadastro do webhook.

![Salvar webhook](/images/radiologists/integrations/webhooks-new/06-save.jpeg)

## Precisa de Ajuda?

Confira nossas [Perguntas Frequentes](/faq) ou entre em contato com o suporte se encontrar problemas ao configurar webhooks.
