...
- [Meu Perfil](/radiologists/account/my-profile)
- [Alterar Senha](/radiologists/account/change-password)
- [Configurações da Conta](/radiologists/account/my-account)

### Fluxo de Trabalho Diário

- [Emitir Laudos](/radiologists/report/issue-reports)
- [Acessar Laudos](/radiologists/report/report-access)
- [Gerenciar Clientes](/radiologists/clients/register-client)

### Recursos Avançados

- [Configuração do Servidor PACS](/radiologists/pacs/pacs-settings)
- [Modelos de Laudos](/radiologists/report/create-report-templates)
- [Configuração do Sistema](/radiologists/report/report-settings)
