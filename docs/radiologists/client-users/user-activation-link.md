# Como Obter o Link de Ativação de um Usuário
...
![Clientes](/images/radiologists/client-users/user-activation-link/01-clients.jpeg)

### 3. Selecione a clínica

Clique sobre a clínica para abrir a página de gerenciamento.

![Selecionar clínica](/images/radiologists/client-users/user-activation-link/02-select-clinic.jpeg)
...
![Usuários da Conta](/images/radiologists/client-users/user-activation-link/03-users-account.jpeg)

### 5. Selecione o usuário

Clique sobre o nome do usuário para o qual deseja obter o link de ativação.

![Selecionar usuário](/images/radiologists/client-users/user-activation-link/04-select-user.jpeg)

### 6. Clique em "Ações"

Na página do usuário, clique no botão **"Ações"** para exibir as opções disponíveis.

![Ações](/images/radiologists/client-users/user-activation-link/05-acoes.jpeg)

### 7. Clique em "Link de Ativação"

No menu de ações, selecione **"Link de Ativação"** para gerar o link de acesso do usuário.

![Link de Ativação](/images/radiologists/client-users/user-activation-link/06-link-ativacao.jpeg)

### 8. Clique em "Copiar Link"

Clique em **"Copiar Link"** para copiar o link de ativação e enviá-lo ao usuário.

![Copiar Link](/images/radiologists/client-users/user-activation-link/07-copiar-link.jpeg)
