...
![Menu de configurações](/images/radiologists/settings/create-tag/01-menu.jpeg)

### 3. Clique em "Tags"

No menu de configurações, clique em **"Tags"** para gerenciar as tags da conta.

![Tags](/images/radiologists/settings/create-tag/02-tags.jpeg)

### 4. Clique em "Nova Tag"

Clique no botão **"Nova Tag"** para iniciar a criação de uma nova tag.

![Nova Tag](/images/radiologists/settings/create-tag/03-new-tag.jpeg)
...
![Inserir tag](/images/radiologists/settings/create-tag/04-inserir-tag.jpeg)

### 6. Clique em "Salvar Tag"

Após inserir o nome, clique em **"Salvar Tag"** para confirmar a criação.

![Salvar Tag](/images/radiologists/settings/create-tag/05-save-tag.jpeg)
