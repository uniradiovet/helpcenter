# Como Configurar a Gestão Financeira
...
![Menu de configurações](/images/radiologists/settings/financial-settings/01-menu.jpeg)

### 3. Clique em "Financeiro"

No menu de configurações, clique em **"Financeiro"** para acessar as configurações de gestão financeira.

![Financeiro](/images/radiologists/settings/financial-settings/02-financeiro.jpeg)
...
![Salvar](/images/radiologists/settings/financial-settings/04-save.jpeg)
