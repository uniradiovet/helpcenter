# Como Configurar a Pesquisa NPS
...
![Menu de configurações](/images/radiologists/settings/nps-settings/01-menu.jpeg)

### 3. Clique em "Pesquisa NPS"

No menu de configurações, clique em **"Pesquisa NPS"** para acessar as configurações de avaliação.

![Pesquisa NPS](/images/radiologists/settings/nps-settings/02-pesquisa-nps.jpeg)
...
![Salvar](/images/radiologists/settings/nps-settings/04-save.jpeg)
