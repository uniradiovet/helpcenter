# Como Visualizar as Exportações Anteriores de Clientes
...
![Seção Clientes](/images/radiologists/clients/export-clients-history/01-clientes.jpeg)

### 3. Abra o menu de opções

Clique no botão de opções (dropdown) para exibir as ações disponíveis para a listagem de clientes.

![Toggle Dropdown](/images/radiologists/clients/export-clients-history/02-dropdown.jpeg)

### 4. Clique em "Exportar Clientes"

Selecione a opção **"Exportar Clientes"** no menu para abrir o painel de exportação.

![Exportar Clientes](/images/radiologists/clients/export-clients-history/03-exportar-clientes.jpeg)
...
![Ver exportações anteriores](/images/radiologists/clients/export-clients-history/04-ver-anteriores.jpeg)
...
![Lista de exportações](/images/radiologists/clients/export-clients-history/05-lista-exportacoes.jpeg)

## Precisa de Ajuda?

Confira nossas [Perguntas Frequentes](/faq) ou entre em contato com o suporte se encontrar problemas ao acessar o histórico de exportações.
