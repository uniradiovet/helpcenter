...
![Menu do usuário](/images/radiologists/security/2fa-enable/01-radiologist.jpeg)

### 3. Clique em "Meu Perfil"

![Meu Perfil](/images/radiologists/security/2fa-enable/02-my-profile.jpeg)
...
![Autenticação de dois fatores desativada](/images/radiologists/security/2fa-enable/03-2fa-desativada.jpeg)

### 5. Clique em "Ativar"

Selecione o método desejado e clique em **"Ativar"** para iniciar o processo.

![Ativar](/images/radiologists/security/2fa-enable/04-activate.jpeg)
...
![Código de verificação](/images/radiologists/security/2fa-enable/05-code.jpeg)

### 7. Clique em "Confirmar"

Clique em **"Confirmar"** para concluir a ativação da autenticação de dois fatores.

![Confirmar](/images/radiologists/security/2fa-enable/06-confirm.jpeg)

## Precisa de Ajuda?

Confira nossas [Perguntas Frequentes](/faq) ou entre em contato com o suporte se encontrar problemas ao ativar a autenticação de dois fatores.
